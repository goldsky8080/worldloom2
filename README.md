...
**http://127.0.0.1:5190/fief**에서 영주가 되어 성·도시·장원·영구 던전이 있는 영지 1개를 관리합니다. v0.2는 지도 중심 HUD와 시설별 행동으로, 병사 모집·외곽 순찰·직접 공략·가상 모험가 의뢰·몬스터 웨이브·도시 피해를 연결합니다. 개발 조작은 기본 닫힌 DEV 패널에 있습니다. 21일 설계/120초 테스트 주기와 도시 레벨별 등급 범위는 유지하며, 비용·피해 등 모든 수치는 임시 프로토타입 값입니다. 실제 경제·전투·서버 영속화는 후속입니다.
