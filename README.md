...
**http://127.0.0.1:5190/fief**에서 영지 1개를 관리합니다. 성·도시·장원 L1과 영구 던전 1개로 시작하여, 도시 레벨별 등급 범위·2분 가속 주기·에테르 증가·모의 공략·던전 폭주를 확인합니다. 운영 설계의 21일 주기와 테스트 값을 구분하며, 실제 세금·전투·서버 영속화는 후속입니다.
