...
`/game` → 경제 → **저장·물류**에서 실제 공용 도시로 이동해 개인 도시 창고 입출고·확장, NPC 배송·진행률, 도착 우편과 거래보관소 부분 수령을 플레이합니다. 인벤토리는 공통 중첩·슬롯·무게 규칙과 Gold/Gem 확장 가격을 적용합니다. 창고는 도시별 독립이며 무게 제한이 없고, 거래보관소는 도착 후 30일 보관·FEFO·7/3/1일 및 소멸 우편을 지원합니다. 새로운 수치 중 아이템 무게·운반 한도·운송속도는 시연값입니다. 영지 던전 원정과 가문 거점은 다음 독립 단계입니다.

[조작·공통 모델·계약·시연값·후속](docs/STORAGE_LOGISTICS_v0.4A.md) · [검증 기록](docs/STORAGE_LOGISTICS_VALIDATION.md)
